...
<head>
    ...
    <body>
        <table class="weather">
            <tr><td>Город:</td><td colspan="2"><span><?php echo $city; ?></span></td></tr>
            <tr><td>Погодные условия:</td><td> <span><?php echo $weather_conditions; ?><span></td><td>
            <tr><td>Температура:</td><td><span><?php echo $temp; ?></span>°C</td><td>
            <tr><td>Влажность:</td><td><span> <?php echo $humidity; ?></span>%</td><td>
            <tr><td>Давление:</td><td><span><?php echo $pressure; ?></span> hpa</td><td>
        </table>
    </body>
</html>
